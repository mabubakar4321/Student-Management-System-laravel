    ...
    <form action="{{ url('student/create') }}" method="POST" >
        ...
        <div class="mb-3">
            ...
            <textarea name="address" id="address" class="form-control  @error('address')
                is-invalid
            @enderror  " rows="3" required></textarea>
        ...
        <div class="mb-3">
            ...
            <input type="text" name="registration_no" id="registration_no" class="form-control"  class="form-control @error('registration_no')
                is-invalid
            @enderror" required>
        ...
        <div class="mb-3">
            ...
            <input type="number" name="phone" id="phone" class="form-control  @error('phone')
                is-invalid
            @enderror" required>
            @error('phone')
                <p class="inalid-feedback">{{ $message }}</p>
